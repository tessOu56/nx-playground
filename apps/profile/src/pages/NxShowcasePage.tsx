export function NxShowcasePage() {
  return (
    <div className="px-4 py-8">
      <h1 className="text-3xl font-bold text-gray-900 mb-8">Nx Monorepo Features</h1>
      
      <div className="space-y-8">
        {/* Feature: Dependency Graph */}
        <div className="bg-white p-6 rounded-lg shadow">
          <h2 className="text-2xl font-bold text-blue-600 mb-4">📊 依賴圖 (Dependency Graph)</h2>
        ...
        {/* Feature: Caching */}
        <div className="bg-white p-6 rounded-lg shadow">
          <h2 className="text-2xl font-bold text-green-600 mb-4">⚡ 智能快取 (Caching)</h2>
          <p className="text-gray-700 mb-4">
        ...
        {/* Feature: Affected */}
        <div className="bg-white p-6 rounded-lg shadow">
          <h2 className="text-2xl font-bold text-purple-600 mb-4">🎯 受影響檢測 (Affected)</h2>
          <p className="text-gray-700 mb-4">
        ...
        {/* Feature: Workspace */}
        <div className="bg-white p-6 rounded-lg shadow">
          <h2 className="text-2xl font-bold text-orange-600 mb-4">🏗️ Workspace 管理</h2>
          <p className="text-gray-700 mb-4">
        ...
        {/* Feature: Generators */}
        <div className="bg-white p-6 rounded-lg shadow">
          <h2 className="text-2xl font-bold text-pink-600 mb-4">⚙️ 代碼生成器 (Generators)</h2>
          <p className="text-gray-700 mb-4">
            快速生成新的應用程式、函式庫或組件。
          </p>
          <div className="bg-gray-50 p-4 rounded space-y-2">
